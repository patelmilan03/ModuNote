...
| 4 | CI/CD — **Landing A** (quality gate, 1 secret) then **Landing B** (signed release → Firebase App Distribution) | 🟡 Landing A green; Landing B reached a signed APK build, one more fix ready, awaiting re-push |
